...
public class ImageController {
    ...
    //Modifying the request to accept imageId as well
    ...
    //Modifying the function to accept additional parameter session.
    ...
    //Modifying the deleteImageSubmit method to take additional parameters session and model of type HttpSession and Model respectively.
