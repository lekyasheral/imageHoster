...
public class ImageRepository {
    ...
    public Image getImagebyuser(Integer imageId, Integer user_id) {
        EntityManager em = emf.createEntityManager();
        TypedQuery<Image> typedQuery = em.createQuery("SELECT i from Image i where i.id =:imageId and i.user_id =:user_id", Image.class).setParameter("imageId", imageId).setParameter("user_id",user_id);
        Image image = typedQuery.getSingleResult();
        return image;
    }
